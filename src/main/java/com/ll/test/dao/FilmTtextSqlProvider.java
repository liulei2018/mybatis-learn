...
public class FilmTtextSqlProvider {

    public String insertSelective(FilmTtext record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("film_text");
    ...
    public String updateByPrimaryKeySelective(FilmTtext record) {
        SQL sql = new SQL();
        sql.UPDATE("film_text");
